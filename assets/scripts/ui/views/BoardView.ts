...
import { BoardModel } from "../../game/models/BoardModel";
import { TileAssetsConfig } from "../configs/TileAssetsConfig";
...
export class BoardView extends cc.Component {
    ...
    @property(TileAssetsConfig)
    tileAssets: TileAssetsConfig | null = null;
