...
@ccclass
export abstract class DynamicTextView<TContext extends DynamicTextViewContext> extends EventPresentationView<TContext> {
    @property(cc.Label)
    ...
    protected preInit(): void {
        super.preInit();
        assertNumber(this.context.initial, this, "initialValue");
    }
    ...
    protected postInit(): void {
        this.render(this.context.initial);
    }
